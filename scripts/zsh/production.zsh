#!/usr/bin/env zsh
# production.zsh - Creates a production distribution of zlux.
# Mirrors the targets defined in production.xml.
#
# Usage: production.zsh [target]
...
setup_dist() {
    ...
    CAPSTONE="${DIST_DIR}" zsh "${dist_build_dir}/scripts/zsh/build_ng2.zsh" removeSource
